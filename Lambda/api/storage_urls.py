...
urlpatterns = [
    ...
    Path("download/{item_id}", download_file, name="download_file"),      # GET /api/storage/download/{item_id}
    Path("item/{item_id}", delete_item, name="delete_item"),              # DELETE /api/storage/item/{item_id}
] 